<!-- =============== 20 YARD — SERVICE AREA =============== -->
<section id="20yd-servicearea" aria-labelledby="20yd-servicearea-heading" style="background:var(--light-bg);">
  <div class="container">
    ...
    <div class="row align-items-center gy-5">
      ...
      <div class="col-lg-6 fade-up">
        ...
        <h2 id="20yd-servicearea-heading">20 Yard Dumpster Rentals Near You</h2>
        <p class="mt-3">
          We Got This Dumpster Rentals delivers 20 yard roll off dumpsters across Orange, Seminole,
          and Volusia Counties and the surrounding areas. If you're within about 50 miles of Sanford,
          FL, there's a good chance we service your area. Give us a call and we'll confirm.
        </p>

        <?php
        $serviceAreas = [
          'Sanford', 'Orlando', 'Longwood', 'Altamonte Springs', 'Maitland',
          'DeLand', 'Orange City', 'DeBary', 'Port Orange', 'Daytona Beach',
          'New Smyrna Beach', 'Belle Isle', 'Edgewood', 'Oviedo', 'Winter Park',
          'Casselberry', 'Lake Mary', 'Deltona',
        ];
        ?>
        <div class="mb-4 mt-3">
        ...
        <p style="font-size:.88rem;color:var(--text-muted);font-style:italic;">
          ...
          We serve roughly a 50 mile radius from Sanford, FL. Don't see your city? Call us anyway — we're always expanding.
        </p>
