<!-- =============== 30 YARD — BOOKING PROCESS =============== -->
<section id="30yd-process" aria-labelledby="30yd-process-heading">
  <div class="container">

    <div class="text-center mb-4 fade-up">
      <span class="section-label">Our Process</span>
      <div class="section-divider mx-auto"></div>
      <h2 id="30yd-process-heading">How To Book A 30 Yard Dumpster Rental</h2>
      <p class="mt-3 mx-auto" style="max-width:600px;color:var(--text-muted);">
        At We Got This Dumpster Rentals, we make it easy to get a 30 yard dumpster rented as soon
