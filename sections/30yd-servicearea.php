<!-- =============== 30 YARD — SERVICE AREA =============== -->
<section id="30yd-servicearea" aria-labelledby="30yd-servicearea-heading" style="background:var(--light-bg);">
  <div class="container">
    ...
    <div class="row align-items-center gy-5">
      ...
      <div class="col-lg-6 fade-up">
        ...
        <h2 id="30yd-servicearea-heading">30 Yard Dumpster Rentals Near You</h2>
        <p class="mt-3">
          We offer 30 yard dumpster rentals in a 50 mile radius around Sanford, FL. We are locally
          owned and operated. If you need a 30 yard dumpster rental delivered near you, we have
          you covered.
        </p>
        ...
        ?>
        <div class="mb-4">
          <?php foreach ($serviceAreas30 as $city): ?>
