  ...
  <div class="row g-0">
    ...
    <div class="col-lg-5">
      <div class="sa-left h-100">
        <div class="ps-lg-5 ps-4">
          ...
          <p class="mt-3">
            We provide expert door and window solutions throughout Northwest Ohio and
            surrounding areas. If you don't see your city, give us a call — we're always
            expanding our reach.
          </p>

          <?php
          $locations = [
            'Fremont', 'Sandusky', 'Port Clinton', 'Clyde', 'Bellevue',
            'Norwalk', 'Tiffin', 'Findlay', 'Fostoria', 'Toledo',
          ];
          ?>
          <div class="mt-3 mb-4">
    ...
    <div class="col-lg-7 sa-right">
      <img src="https://placehold.co/900x480/e2e8f0/6b7a99?text=Service+Area+Map+-+Northwest+Ohio"
           alt="Tritch Door &amp; Window Service Area Map">
    </div>
