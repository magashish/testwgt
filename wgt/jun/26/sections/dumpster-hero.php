<!-- =============== DUMPSTER SIZE HERO =============== -->
<section id="dumpster-hero" class="inner-hero" aria-label="<?php echo $dumpster['yards']; ?> Yard Dumpster Hero" style="background-image: url(/assets/images/20220923_093559-scaled.webp);">
        ...
        <div class="row g-3">
          ...
          <div class="col-6">
            <div class="hero-badge-box">
              ...
              <div class="hb-label">Long · 7 ft Wide</div>
            </div>
          </div>
          <div class="col-6">
            <div class="hero-badge-box">
