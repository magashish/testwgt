...
<section id="dumpster-servicearea" class="section-space" aria-labelledby="dumpster-servicearea-heading" style="background:var(--light-bg);">
  <div class="container">
      ...
      <div class="col-lg-6 fade-up" style="transition-delay:.15s;">
        <div class="text-center p-5 rounded"
          ...
          <div class="mt-3 p-3 rounded" style="background:var(--light-bg);">
            <div style="font-size:1.1rem;font-weight:800;color:var(--primary);">~30 Mile Radius</div>
