...
<section id="services-process" class="section-space" aria-labelledby="services-process-heading">
  <div class="container">

    <div class="text-center mb-4 fade-up">
      <span class="section-label">Our Process</span>
      <div class="section-divider mx-auto"></div>
      <h2 id="services-process-heading">Get The Dumpster You Need In Three Easy Steps</h2>
      <p class="mt-3 mx-auto" style="max-width:900px;color:var(--text-muted);">
        At We Got This Dumpster Rentals, we make it easy to get the dumpster you need as soon as
        the same day. Follow these three easy steps to get the right size dumpster on site fast!
      </p>
    </div>
